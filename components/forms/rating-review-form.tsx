...
export default function RatingReviewForm() {
    ...
    const onSubmit = async (values: z.infer<typeof ReviewsRatingsSchema>) => {
        ...
        try {
            await axios.post(`/api/reviews-ratings`, formData, {
                headers: {
                    "Content-Type": "multipart/form-data",
                },
            });

            handleSuccess("Rating created successfully", "create");
            router.refresh();
        } catch (error) {
    ...
    return (
        <main className="flex flex-col items-center justify-center min-h-screen p-6">
            ...
            <h1 className="text-2xl font-bold mb-6">Create Ratings and Reviews</h1>
            <Form {...form}>
                <form
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea className="min-h-[100px]" placeholder="commnet Description" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
